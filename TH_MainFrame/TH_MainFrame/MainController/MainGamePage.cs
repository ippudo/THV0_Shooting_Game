    ...
    public class MainGamePage:DrawableGameComponent,IPage
    {
        ...
        public void InitPage()
        {
            ...
            menuBuilder.AddItem(new BasicMenuItem(
                ...
                delegate(object sender, EventArgs e) { ((Game1)gameLink).JumpToPage("MainMenu", 0); },
                new Vector2(0, 60), "Back To Title"));
            menuBuilder.AddItem(new BasicMenuItem(
                gameLink.Content.Load<Texture2D>(@"Menu/Item/MainMenu_Skip"),
                delegate(object sender, EventArgs e) { inGameMenu.IsAvaliable = false; testGame.Reset(3); },
        ...
        Color halfRedToumei=new Color(128,0,0,64);
