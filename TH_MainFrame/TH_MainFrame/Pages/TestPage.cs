...
namespace THPages.Pages
{
    public class TestPage:DrawableGameComponent,IPage
    {
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (Keyboard.GetState().IsKeyDown(Keys.T)) ((Game1)gameLink).JumpToPage("TEST2", 0,true);
            if (Keyboard.GetState().IsKeyDown(Keys.M)) ((Game1)gameLink).JumpToPage("MainMenu", 0,true);
